...
if __name__ == "__main__":
    checkpoints = [
        [1.801448077821011,  -0.7272143308845652,  -0.17600744219629474, 0.9843888359238527],
        [0.75413808767915,    0.6935195599805307,   0.8738231258256374,  0.48624391489489344],
        [3.6704948592312454, -1.8971807817955268,  -0.34134149988312906, 0.9399393493505502],
        [6.128891746903331,  -2.156612477116119,  -0.100474241670117,   0.9949396598592374],
    ]
    follower = Follower()
