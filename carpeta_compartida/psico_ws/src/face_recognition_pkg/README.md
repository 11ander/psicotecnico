...
Este módulo **no guarda imágenes**, guarda **embeddings** (vectores) en un JSON.  
Aun así, los embeddings son **datos biométricos**: evita subir a repositorios públicos datos reales de pacientes, y protege el fichero `embeddings_db.json` en despliegues reales.

---

## Autores

- Equipo del proyecto **psicotecnico** (Universidad de Deusto).
- Módulo `face_recognition_pkg`: Asier Burgos.

---

## Licencia

Uso académico / proyecto interno. (Ajustar según la licencia global del repositorio).
