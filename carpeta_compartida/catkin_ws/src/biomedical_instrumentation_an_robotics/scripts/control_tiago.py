...
class ControladorTiago():
    def __init__(self):
        ...
        self.__arm_torso_commander = moveit_commander.move_group.MoveGroupCommander(self.__arm_torso_group_name)
        self.__gripper_commander = moveit_commander.move_group.MoveGroupCommander(self.__gripper_group_name)
        sleep(2)
    ...
    def move_gripper(self, width: float) -> bool:
        ...
        self.__gripper_commander.go([width/2,width/2])
    ...
    def set_velocity_and_acceleration_arm(self, velocity: float, acceleration: float) -> None:
        ...
        self.__arm_torso_commander.set_max_velocity_scaling_factor(velocity)
        self.__arm_torso_commander.set_max_acceleration_scaling_factor(acceleration)
    ...
    def set_velocity_and_acceleration_gripper(self, velocity: float, acceleration: float) -> None:
        ...
        velocity = velocity if velocity > 0 and velocity <= 1.0 else 0.1
        acceleration = acceleration if acceleration > 0 and acceleration <= 1.0 else 0.1
        self.__gripper_commander.set_max_velocity_scaling_factor(velocity)
        self.__gripper_commander.set_max_acceleration_scaling_factor(acceleration)
    ...
    def move_joints(self, joints: list) -> bool:
        ...
        """
        return self.__arm_torso_commander.go(joints)
    ...
    def get_current_joints(self) -> list:
        ...
        """
        return deepcopy(self.__arm_torso_commander.get_current_joint_values())
    ...
    def move_to_pose(self, pose: Pose) -> bool:
        ...
        pose_aux.header.frame_id = self.__arm_torso_commander.get_end_effector_link()
        pose_aux.pose = pose
        self.__arm_torso_commander.set_pose_target(pose_aux)
        return self.__arm_torso_commander.go()
    ...
    def move_to_position(self, position: list) -> bool:
        ...
        Returns:
            bool: True if the movement was successful, False otherwise.
        """
        self.__arm_torso_commander.set_position_target(position)
        return self.__arm_torso_commander.go()
    ...
    def move_in_straight_line(self, list_of_poses: list, strict: bool=True) -> bool:
        ...
        Returns:
            bool: True if the movement was successful, False otherwise.
        """
        (plan, fraction) = self.__arm_torso_commander.compute_cartesian_path(
            list_of_poses, 0.01
        )

        if fraction == 1.0:
            return self.__arm_torso_commander.execute(plan)
